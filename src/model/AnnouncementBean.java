...
public class AnnouncementBean {
	...
	public static ResultSet getAllAnnouncements()throws SQLException{
		ResultSet rs = null;
		String sql = "SELECT a.email AS \"email\", CONCAT(u.firstName,  \" \", u.lastName) as \"name\", a.announcementBody AS \"announcementBody\", a.file AS \"FILE\", a.tags AS \"TAGS\", a.dateposted AS \"datePosted\", a.timeposted AS \"timePosted\"\r\n" + 
