...
<% ArrayList<String> tags = new ArrayList<String>();
	tags.add("General");
	tags.add("School of Computing");
	tags.add("School of Design");
	tags.add("School of Business");
	tags.add("Software Engineering");
	tags.add("Game Development");
	tags.add("Web Development");
	tags.add("Animation");
	tags.add("Multimedia Arts");
	tags.add("Fashion Design");
	tags.add("Business Administration");
	tags.add("Financial Management");
...
<body>
    ...
    <section class="top-nav">
        ...
        <!-- TOP NAVIGATOR -->
        <ul class="menu">
          <a href="homePage_sender.html"><li class="textFix"><font color="white">Home</a></li></font>
          <a href="homePage_sender.html"><li class="textFix"><font color="white">Compose Announcement</a></li></font>
          ...
          <a href="#"><li class="textFix"><font color="white">Sign Out</a></li></font>
        </ul>
      </section>
    ...
    <!-- TEXT AREA -->
    <div class="container"><textarea placeholder="Please input content/s of announcement" class="textFix"></textarea>
    </div>
    <div class = "container">
    <%for(String s : tags){ %>
     <input type = "checkbox" name = "tagged" value = <%=s %>><%=s %>
     <br>
     <%} %>
    </div>
